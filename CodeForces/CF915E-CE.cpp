...
class SegTree{
    private:
        ...
        static Node nd[31000000];
        static Node* rt;
    public:
        // SegTree(void){rt = new Node{npt, npt, 0, -1};}
...
void* SegTree::Node::operator new(size_t){static Node* P = nd; return P++;}
SegTree::Node* SegTree::rt = new Node{npt, npt, 0, -1};
